					...
					<div className={styles.infoInner}>
						<div className={styles.avatarContainer}>
							<img
								...
								onError={e => {
									e.currentTarget.src =
										'https://via.placeholder.com/200x200/00d4ff/ffffff?text=RA'
								}}
							/>
					...
					<>
						<div className={styles.projectList}>
							<div className={styles.projectItem}>
								...
								>
									ParkNGo: Urban Parking and Reservation
									Platform
								...
								<p>
									• Architected a full-stack parking platform
									with 12+ features, including real-time
									availability, reservations, and user
									authentication, by engineering over 25
									secure REST APIs.
								</p>
								<p>
									• Optimized a MySQL database with Prisma
									ORM, achieving efficient data handling and
									API response times under 150ms.
								</p>
								<p>
									• Built a secure, role-based dashboard with
									5+ analytical modules to monitor revenue and
									user growth.
								</p>
								<p>
									• Integrated the PayU payment gateway,
									implementing secure transaction protocols to
									achieve a 99.9% success rate.
								</p>
								<div className={styles.projectLinks}>
									<a
										href="https://park-n-go-eosin.vercel.app/"
										target="_blank"
									...
									<a
										href="https://github.com/rafiaabbasi24/ParknGO"
										target="_blank"
										rel="noopener noreferrer"
									>
							...
							<div className={styles.projectItem}>
								<strong
									...
									onClick={() =>
										window.open(
											'https://github.com/rafiaabbasi24/Resume-job-matcher',
											'_blank'
										)
									}
								>
								...
								<p>
									• Built an automated resume-matching tool
									using Python and NLP, designed to reduce
									manual screening time by over 75%.
								</p>
								<p>
									• Engineered a data preprocessing pipeline
									that improved text extraction accuracy from
									PDF/DOCX files by over 95%.
								</p>
								<p>
									• Implemented TF-IDF and cosine similarity
									algorithms, achieving a 92% match accuracy
									rate.
								</p>
								<div className={styles.projectLinks}>
									<a
										href="https://github.com/rafiaabbasi24/Resume-job-matcher"
										target="_blank"
										rel="noopener noreferrer"
									>
										<i className="fab fa-github"></i> GitHub
							...
							<div className={styles.projectItem}>
								<strong
									...
									onClick={() =>
										window.open(
											'https://github.com/rafiaabbasi24/Disk-Scheduling-Algorithm-Visualizer',
											'_blank'
										)
									}
								>
								...
								<p>
									• Created an interactive web-based tool to
									visualize six key disk scheduling
									algorithms, improving user comprehension by
									an estimated 40%.
								</p>
								<p>
									• Leveraged HTML5 Canvas for animations and
									used Plotly.js to generate 5+ real-time
									performance comparison charts.
								</p>
								<p>
									• Implemented a secure user authentication
									system using PHP and MySQL, providing
									personalized progress tracking for 50+ beta
									users.
								</p>
								<div className={styles.projectLinks}>
									<a
										href="https://github.com/rafiaabbasi24/Disk-Scheduling-Algorithm-Visualizer"
										target="_blank"
										rel="noopener noreferrer"
									>
										<i className="fab fa-github"></i> GitHub
			...
			return (
				<div className={styles.skillsSection}>
					<div className={styles.skillCategory}>
						<strong className={styles.skillHeading}>
							Languages:
						</strong>
		...
		execute() {
			...
			return (
				<div className={styles.resumeSection}>
					<p>
						📄 <strong>Opening your resume...</strong>
					</p>
					<p>
